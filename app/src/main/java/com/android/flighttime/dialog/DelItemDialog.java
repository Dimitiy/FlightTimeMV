...
public class DelItemDialog extends DialogFragment {
    ...
    public static DelItemDialog newInstance(int groupPosition, int childPosition) {
        final DelItemDialog frag = new DelItemDialog();
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                callback.onClickToDeleteMission(groupPosition);
            }
        });
